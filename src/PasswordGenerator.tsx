...
const PasswordGenerator = () => {
    const {length, setLength, includeNumbers, toggleNumbers, includeSymbols, toggleSymbols, includeUppercase, toggleUppercase, includeLowercase, toggleLowercase, generatedPassword, generatePassword} = usePasswordStore();
  ...
  return (
    <div className="p-8 w-[40rem] mx-auto bg-white shadow-lg rounded-lg">
        ...
        <div className="flex flex-col gap-4">
            ...
            <button onClick={handleGeneratePassword} className="mt-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Generate Password</button>
